...
<?php echo hook('pageHeader');?>
	...
	<script type="text/javascript" src="/Public/Home/js/login.js" language="javascript"></script>    
</head>
<body>
	<!-- 头部 -->
	<!-- 导航条
...
<div class="all">
	<div class="allmain"  style="margin-bottom:130px;">
		<div class="mainleft">
			<img src="/Public/Home/images/user/picc.jpg" alt="微风投" width="100%"/>
		</div>
		<div class="mainright">
			<div class="mansec">
				<div id="result"></div>
				<div id="list"></div>
				<form name="loginform" id="loginform" action="/index.php?s=/home/user/denglu"  method="post" >
					<div class="man">
						<input name="username" id="username" type="text" placeholder="请输入邮箱/昵称" autocomplete="off" maxlength="20" />
						<span id="usernamecue"></span>
					</div>
					<div class="sec">
						<input name="password" id="password" type="password" placeholder="请输入密码" autocomplete="off" />
						<span id="passwordcue"></span>
					</div>
					<div class="rem">
						<span class="yesme" style="background-position: 0px -33px;">
							<input type="checkbox" id="rememberusername" checked="checked"></span>
					...
					<div class="lgoinin">
						...
						<input type="image" style="width:165px;height:40px;" id="login" name="submit" src="/Public/Home/images/user/login.gif"></div>
				</form>
				<div class="lgoword">
					没有账号？
					<a href="<?php echo U('register');?>">免费注册</a>
				</div>
			...
			<div class="qier">
				...
				<div class="partner-weibo" id="_wb_connect_btn">
					<!-- <a href="https://api.weibo.com/oauth2/authorize?client_id=<?php echo C('WEIBO_APP_ID');?>&response_type=code&redirect_uri=<?php echo C('WEB_URL');?>/index.php?s=Home/User/weibologin" target="_blank"></a> -->
